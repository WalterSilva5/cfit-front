...
export const WorkoutForm: React.FC<FormProps> = () => {
	const api = new Api();
		...
		async (values: FormData, actions: FormikHelpers<FormData>) => {
			...
			try {
				...
				swal.fire({
					icon: 'error',
					title: 'Oops...',
					text: 'Ocorreu um erro ao salvar o workout'
				});
			}
		},
		[id]
	...
	const validationSchema = Yup.object().shape({
		name: Yup.string().required('Nome do workout é obrigatório'),
		imageUrl: Yup.string()
