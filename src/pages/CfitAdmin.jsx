...
const CfitAdmin = () => (
  <div>
    ...
    <div className="row container-fluid" style={{minHeight: '70vh' }}>
        ...
        <div className="p-2">
            <NavLink className="btn btn-primary col-12 my-1" to="/cfit_admin/playlists">PLAYLISTS</NavLink>
            <NavLink className="btn btn-primary col-12 my-1" to="/cfit_admin/usuarios">USUARIOS</NavLink>
            <NavLink className="btn btn-primary col-12 my-1" to="/cfit_admin/mensagens">MENSAGENS</NavLink>
            <NavLink className="btn btn-primary col-12 my-1" to="/cfit_admin/add_aula">ADD AULA</NavLink>
            <NavLink className="btn btn-primary col-12 my-1" to="/cfit_admin/ajustes">AJUSTES</NavLink>
        </div>
        </div>
